...
public class WelcomePageObject extends MainPageObject {
    ...
    private static final String
        ...
        STEP_ADD_OR_EDIT_PREFFERED_LANGUAGES_LINK = "Add or edit preferred languages",
    ...
    {
        this.waitForElementPresent(By.id(STEP_ADD_OR_EDIT_PREFFERED_LANGUAGES_LINK), "Cannot find 'Add or edit preferred languages' link", 10);
    }

    public void waitForLearnMoreAboutDataCollectedText()
    {
        this.waitForElementPresent(By.id(STEP_LEARN_MORE_ABOUT_DATA_COLLECTED_TEXT), "Cannot find 'Learn more about data collected' text", 10);
    }
